 ...
 * */
void twi_master_setup(/*uint16_t scl_freq*/ void)
{
 ...
 */
void twi_slave_setup(uint8_t address, volatile uint8_t *transmit_buffer,
 ...
 * */
void twi_write_bytes(uint8_t add, uint8_t nb_bytes, volatile uint8_t *buffer)
{
